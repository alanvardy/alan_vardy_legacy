defmodule AlanVardy.Email.Contact do
  ...
  @spec compose(AlanVardy.Email.Content.t()) :: Bamboo.Email.t()
  ...
  @spec contact_html_body(AlanVardy.Email.Content.t()) :: String.t()
  ...
  @spec contact_text_body(AlanVardy.Email.Content.t()) :: String.t()
